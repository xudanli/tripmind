export default {
  ...
  travelDetail: {
    ...
    weather: {
      ...
      noJourneyId: '需要行程ID才能获取天气信息',
      error: '获取天气信息失败',
      journeyNotFound: '行程不存在',
      noDaysInfo: '行程没有天数信息，无法获取天气信息',
      currentWeather: '当前天气',
      forecast: '天气预报',
      typicalWeather: '典型天气',
      averageTemperature: '平均温度',
      rainfall: '降雨信息',
      clothingSuggestions: '穿衣建议',
      safetyAdvice: '安全建议',
      safetyAlerts: '安全警示',
      packingSuggestions: '打包建议',
      travelTips: '旅行建议',
      realtime: '实时天气',
      historical: '历史气候',
      fromCache: '来自缓存',
    ...
    packingList: {
      ...
      loading: '正在生成智能打包清单...',
      retry: '重试',
      unavailable: '打包清单暂不可用',
      noJourneyId: '需要行程ID才能生成打包清单',
      error: '获取打包清单失败',
      journeyNotFound: '行程不存在',
      noDaysInfo: '行程没有天数信息，无法生成打包清单',
      items: '项',
      fromCache: '来自缓存',
      generatedAt: '生成时间'
    },
