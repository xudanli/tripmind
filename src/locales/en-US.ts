export default {
  ...
  travelDetail: {
    ...
    weather: {
      ...
      noJourneyId: 'Journey ID required to get weather information',
      error: 'Failed to get weather information',
      journeyNotFound: 'Journey not found',
      noDaysInfo: 'Journey has no days information, unable to get weather information',
      currentWeather: 'Current Weather',
      forecast: 'Weather Forecast',
      typicalWeather: 'Typical Weather',
      averageTemperature: 'Average Temperature',
      rainfall: 'Rainfall Information',
      clothingSuggestions: 'Clothing Suggestions',
    ...
    packingList: {
      ...
      loading: 'Generating smart packing list...',
      retry: 'Retry',
      unavailable: 'Packing list unavailable',
      noJourneyId: 'Journey ID required to generate packing list',
      error: 'Failed to get packing list',
      journeyNotFound: 'Journey not found',
      noDaysInfo: 'Journey has no days information, unable to generate packing list',
      items: 'items',
      fromCache: 'From Cache',
      generatedAt: 'Generated at'
    },
